...
public class DialogManager : MonoBehaviour
{
    ...
    public void LoadPieceOfDialog()
    {
        ...
        {
            float typingAnimOffset = _dialogOffset - ((pieceOfDialogToLoad.GetComponent<SpriteRenderer>().sprite.bounds.max.y / 2f) / 0.7f) + ((TypingAnimObj.GetComponent<SpriteRenderer>().sprite.bounds.max.y / 2f) / 0.7f);
